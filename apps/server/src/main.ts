...
import { ALLOWED_ORIGINS, ATTRIBUTION, DB_PATH, GOOGLE_PLACES_API_KEY, GYM_RECORDS, HOST, PHOTO_DIR, PORT } from './config';
...
const server = createServer(
  createApp({ db, attribution: ATTRIBUTION, allowedOrigins: ALLOWED_ORIGINS, photoDir: PHOTO_DIR, googleKey: GOOGLE_PLACES_API_KEY }),
);
