...
| Search around you before the nearest city | Outside the carried cities, finding you jumped to the nearest one, sometimes hundreds of kilometres off. With the area search in place, the honest answer is the gyms around you, from the map; the nearest city is now only the fallback (outside AU and the US, or map servers down). |
