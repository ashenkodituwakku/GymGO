...
| The US is the main market | Asked to focus on the USA. 25 more US metros (40 in all, 1,055 gyms), fetched by bounding box through lz4.overpass-api.de; sprawling ones (Phoenix, Dallas, Orlando…) get 8–10 km circles like Los Angeles, since a downtown circle held only a handful of mapped gyms; a gym two circles share (Brooklyn and New York) is listed once. The US leads the country list and Home, New York is where the app opens before a country is chosen, and search takes states ("Texas", "TX") and ZIP codes ("10001", your own country's match first). |
